...
<div>
    <div class="mb-4" data-aos="fade-down">
        <div class="d-flex align-items-center gap-3 mb-3">
            ...
            <h3 class="fw-bold text-dark mb-0">Add New Medicine</h3>
        </div>
        <p class="text-muted">Enter medicine details below</p>
    </div>
        ...
        <div class="col-lg-8" data-aos="fade-up">
            <div class="card shadow-sm">
                <div class="card-body p-4">
                    <form method="POST" action="{{ route('medicines.store') }}" class="d-flex flex-column gap-3">
                        @csrf
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-icon-wrapper">
                                    <input type="text" id="brand_name" name="brand_name" value="{{ old('brand_name') }}" required
                                           class="form-control ps-4" placeholder="Enter brand name">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-icon-wrapper">
                                    <input type="text" id="generic_name" name="generic_name" value="{{ old('generic_name') }}" required
                                           class="form-control ps-4" placeholder="Enter generic name">
                        ...
                        <div class="row g-3">
                            <div class="col-md-4">
                                ...
                                <input type="text" id="dosage_type" name="dosage_type" value="{{ old('dosage_type') }}"
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" id="package_mark" name="package_mark" value="{{ old('package_mark') }}"
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-icon-wrapper">
                                    <input type="text" id="company_name" name="company_name" value="{{ old('company_name') }}"
                                           class="form-control ps-4" placeholder="Enter company name">
