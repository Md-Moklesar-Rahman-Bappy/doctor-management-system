...
<body class="bg-gray-100 text-gray-900 antialiased">
    ...
    <div class="flex min-h-screen">
        ...
        <aside class="sidebar" id="sidebar">
            <div class="sidebar-header">
                ...
                <span class="text-lg font-bold text-gray-900">Doctor</span>
            </div>
        ...
        <div class="flex-1 lg:ml-64">
            <!-- Header -->
            <header class="header">
                <button class="lg:hidden p-2 -ml-2 text-gray-500 hover:text-gray-700" id="menu-toggle">
                ...
                <div class="flex items-center gap-4 ml-auto">
                    ...
                    <div x-data="{ open: false }" class="relative">
                        <button @click="open = !open" class="flex items-center gap-3 hover:bg-gray-50 rounded-lg px-3 py-2">
    ...
    <div class="fixed inset-0 z-40 bg-gray-900/50 hidden" id="sidebar-overlay"></div>
    @else
