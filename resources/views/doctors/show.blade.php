        ...
        <div class="lg:col-span-1">
            <div class="bg-white rounded-xl border border-slate-200">
                ...
                <div class="px-6 py-4 border-t border-slate-200">
                    <a href="/doctors/{{ $doctor->id }}/edit" class="inline-flex items-center gap-2 px-4 py-2 bg-amber-500 hover:bg-amber-600 text-white text-sm font-medium rounded-lg">
