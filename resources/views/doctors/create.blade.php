...
<div>
    <div class="mb-8">
        <div class="flex items-center gap-4 mb-4">
            ...
            <h3 class="text-2xl font-bold text-slate-900">Add New Doctor</h3>
        </div>
        <p class="text-slate-500">Enter doctor details below</p>
    </div>

    <div class="max-w-2xl mx-auto">
        <div class="bg-white rounded-xl border border-slate-200 p-6">
            <form method="POST" action="/doctors" class="space-y-4">
                @csrf
                ...
                <div>
                    ...
                    <textarea id="address" name="address" required
                              class="w-full px-3 py-2 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500">{{ old('address') }}</textarea>
                </div>
