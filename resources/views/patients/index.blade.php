...
<div>
    <div class="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <a href="{{ route('patients.create') }}" class="inline-flex items-center gap-2 px-4 py-2.5 bg-emerald-500 hover:bg-emerald-600 text-white font-semibold rounded-lg">
    ...
    <div class="bg-white rounded-xl border border-slate-200 overflow-hidden">
        <div class="p-4 border-b border-slate-200">
                ...
                @if($search)
                <a href="{{ route('patients.index') }}" class="px-3 py-2 text-slate-500 hover:text-slate-700">
                    ...
                    <tr class="hover:bg-slate-50">
                        ...
                        <td class="px-4 py-4">
                            <div class="flex items-center gap-2">
                                <a href="{{ route('patients.show', $patient->id) }}" class="p-3 text-sky-600 hover:bg-sky-50 rounded-lg" title="View">
                                ...
                                <a href="{{ route('patients.edit', $patient->id) }}" class="p-3 text-blue-600 hover:bg-blue-50 rounded-lg" title="Edit">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/></svg>
                                </a>
                                <a href="{{ route('prescriptions.create') }}?patient_id={{ $patient->id }}" class="p-2 text-emerald-600 hover:bg-emerald-50 rounded-lg" title="Create Prescription">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                                </a>
                                <a href="{{ route('lab_test_reports.create') }}?patient_id={{ $patient->id }}" class="p-3 text-amber-600 hover:bg-amber-50 rounded-lg" title="Add Lab Report">
