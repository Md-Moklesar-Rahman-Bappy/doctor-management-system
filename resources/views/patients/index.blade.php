                    ...
                    <tr class="hover:bg-slate-50">
                        ...
                        <td class="px-4 py-4">
                            <div class="flex items-center gap-2">
                                <a href="/patients/{{ $patient->id }}" class="p-2 text-sky-600 hover:bg-sky-50 rounded-lg" title="View">
                                ...
                                <a href="/patients/{{ $patient->id }}/edit" class="p-2 text-blue-600 hover:bg-blue-50 rounded-lg" title="Edit">
                                ...
                                <a href="/lab-test-reports/create?patient_id={{ $patient->id }}" class="p-2 text-amber-600 hover:bg-amber-50 rounded-lg" title="Add Lab Report">
                                ...
                                <form action="/patients/{{ $patient->id }}" method="POST" class="inline">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="p-2 text-red-600 hover:bg-red-50 rounded-lg" title="Delete" onclick="return confirm('Delete this patient?')">
